  ...
  return (
    ...
    >
      ...
      >
        ...
        <path
          d="M10,50 A40,40 0 0,0 50,90 A40,40 0 0,0 90,50"
          strokeWidth="1"
          strokeDasharray="3 3"
        />
      </svg>
        ...
        >
          ...
          <div className="md:col-span-7 text-left space-y-8 relative py-4">
            ...
            <ScrollParagraph className="font-sans text-sm md:text-base text-[#FAF7EE] leading-relaxed font-light">
              UEM Conclave of Nations(UEMCON) stands as one of Kolkata’s premier
              Model United Nations conferences, organised by the University of
              Engineering & Management, Kolkata. It is more than just a
              simulation of diplomacy, UEMCON is a dynamic platform where
              students step into the world of international relations,
            ...
            <ScrollParagraph className="font-sans text-xs sm:text-sm text-[#F4ECD8]/75 leading-relaxed font-light">
              This event rightfully acknowledges the passion, commitment and
              quality of the delegates. At the end of the two days conference,
              phenomenal candidates from every committee are honoured for their
              extreme hardwork and outstanding performance with awards and merit
              certificates.
            </ScrollParagraph>

            <ScrollParagraph className="font-sans text-xs sm:text-sm text-[#F4ECD8]/75 leading-relaxed font-light">
              At its core, UEMCON celebrates the spirit of intense debate,
              adequate discourse and personal growth. It provides delegates —
              whether first-timers or experienced participants — with an
              opportunity to challenge themselves with the global affairs,
              refine their skills, and leave a lasting impact through their
