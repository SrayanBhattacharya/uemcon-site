      ...
      <Container className="max-w-5xl">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 items-start">
          ...
          <div className="md:col-span-5 text-left space-y-4">
            ...
            <h2 className="font-sans font-black text-4xl sm:text-5xl lg:text-6xl text-[#F4ECD8] uppercase tracking-tighter leading-[0.9] flex flex-col">
              <span>What is</span>
              <span className="text-[#CBAD7F]">UEMCON?</span>
            </h2>
          ...
          <div className="md:col-span-7 text-left space-y-6">
            <p className="font-sans text-sm md:text-base text-[#FAF7EE] leading-relaxed font-light">
              UEM Model United Nations (UEMCON) is an engaging extracurricular pursuit that immerses students in the world of global diplomacy. As young delegates step into the roles of United Nations representatives and engage in discussions within simulated UN committees, their intellect, knowledge, and prowess are put to the test.
            </p>
